    ...
    <div className="relative w-full h-[100svh] overflow-hidden bg-stone-900">
      ...
      <div className="relative z-20 h-full max-w-[90rem] mx-auto px-6 md:px-12 flex flex-col justify-center">
        ...
        <div className="max-w-5xl pt-32 md:pt-48 lg:pt-60">
          {/* Tagline - TEAM_034: Use warm terracotta for the divider to welcome guests with store's cozy wall colors */}
          <div className="inline-flex items-center gap-4 mb-8 md:mb-12 animate-fade-in-up">
            <div className="w-12 md:w-20 h-[1px] bg-terracotta-400/80"></div>
          ...
          <h1 className="text-7xl md:text-9xl lg:text-[11rem] text-white font-serif mb-10 leading-tight md:leading-[0.8] tracking-tight animate-fade-in-up delay-100 drop-shadow-2xl">
            ...
            <span className="relative inline-block ml-16 md:ml-40">
              ...
              {/* Refined Glow - TEAM_034: Warm terracotta ambient glow representing the shop's warm lighting */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 md:w-80 md:h-80 bg-terracotta-500/25 rounded-full blur-[100px] -z-10"></div>
            </span>
          </h1>

          {/* Description - Refined & Polished */}
          <div className="flex flex-col gap-8 mt-12 md:mt-16 animate-fade-in-up delay-200 max-w-2xl">
            <p className="text-stone-200 text-lg md:text-2xl font-light leading-relaxed border-l-[3px] border-terracotta-500/60 pl-8 md:pl-10 drop-shadow-lg">
              {t.hero.desc}
