    ...
    <section id="services" className="py-24 md:py-32 bg-stone-50 relative overflow-hidden min-h-screen">
      <div className="max-w-5xl mx-auto px-6">
        <div className="mb-16 md:mb-24 text-center">
          {/* TEAM_034: Use warm terracotta for the services tagline to reflect shop's ambient colors */}
          <span className="text-terracotta-600 uppercase tracking-[0.4em] text-[10px] font-bold mb-4 block animate-fade-in">{t.services.menu}</span>
                          ...
                          >
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                              <div className="space-y-1">
                                {/* TEAM_034: Change hover color to terracotta to reflect physical store environment */}
                                <h4 className="text-lg font-bold text-stone-900 group-hover/item:text-terracotta-600 transition-colors">
